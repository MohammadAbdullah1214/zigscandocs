...
import { Loader2, Copy, CircleChevronRight } from "lucide-react";
...
export function ApiPlaygroundModal({
  ...
  const handleSendRequest = async () => {
    ...
    try {
      ...
      const queryParams = endpoint.parameters.reduce((acc, param) => {
        if (parameters[param.name]) {
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="flex items-center gap-2 bg-muted p-3 rounded-lg">
                ...
                >
                  ...
                  <CircleChevronRight className="h-1 w-1" />
                </Button>
              </div>
            </div>
            ...
            <p className="text-xs text-muted-foreground">
              Enter your API key above to test the endpoint
            </p>
          </div>
